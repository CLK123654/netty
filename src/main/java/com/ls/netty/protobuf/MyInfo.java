...
public final class MyInfo {
  ...
  public interface MyMessageOrBuilder extends
     ...
     * <code>.Teacher tcer = 3;</code>
     */
    TeacherOrBuilder getTcerOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return MyInfo.internal_static_MyMessage_descriptor;
    }

    @Override
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return MyInfo.internal_static_MyMessage_fieldAccessorTable
    ...
    public static final int TCER_FIELD_NUMBER = 3;
    /**
     * <code>.Teacher tcer = 3;</code>
     */
    public boolean hasTcer() {
      return dataBodyCase_ == 3;
    }
    /**
     * <code>.Teacher tcer = 3;</code>
     */
    public Teacher getTcer() {
      if (dataBodyCase_ == 3) {
     ...
     * <code>.Teacher tcer = 3;</code>
     */
    public TeacherOrBuilder getTcerOrBuilder() {
      if (dataBodyCase_ == 3) {
         return (Teacher) dataBody_;
      }
      return Teacher.getDefaultInstance();
    ...
    public boolean equals(final Object obj) {
      ...
      switch (dataBodyCase_) {
        case 2:
          ...
          break;
        case 3:
          result = result && getTcer()
              .equals(other.getTcer());
          break;
        case 0:
        default:
      }
    ...
    public int hashCode() {
      ...
      switch (dataBodyCase_) {
        case 2:
          ...
          break;
        case 3:
          hash = (37 * hash) + TCER_FIELD_NUMBER;
          hash = (53 * hash) + getTcer().hashCode();
          break;
        case 0:
        default:
      }
    ...
    public static final class Builder extends
      ...
      // Construct using com.ls.netty.protobuf.MyInfo.MyMessage.newBuilder()
      private Builder() {
      ...
      public MyMessage buildPartial() {
        ...
        if (dataBodyCase_ == 3) {
          if (tcerBuilder_ == null) {
            result.dataBody_ = dataBody_;
          } else {
            result.dataBody_ = tcerBuilder_.build();
          }
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          Teacher, Teacher.Builder, TeacherOrBuilder> tcerBuilder_;
      /**
       * <code>.Teacher tcer = 3;</code>
       */
      public boolean hasTcer() {
      ...
      public Teacher getTcer() {
        if (tcerBuilder_ == null) {
          ...
          if (dataBodyCase_ == 3) {
            return tcerBuilder_.getMessage();
          }
          return Teacher.getDefaultInstance();
        }
      }
       ...
       * <code>.Teacher tcer = 3;</code>
       */
      public Builder setTcer(Teacher value) {
        if (tcerBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Teacher tcer = 3;</code>
       */
      public Builder setTcer(
          Teacher.Builder builderForValue) {
        if (tcerBuilder_ == null) {
          dataBody_ = builderForValue.build();
          onChanged();
        } else {
          tcerBuilder_.setMessage(builderForValue.build());
        }
        dataBodyCase_ = 3;
        return this;
      }
       ...
       * <code>.Teacher tcer = 3;</code>
       */
      public Builder mergeTcer(Teacher value) {
        if (tcerBuilder_ == null) {
          if (dataBodyCase_ == 3 &&
       ...
       * <code>.Teacher tcer = 3;</code>
       */
      public Teacher.Builder getTcerBuilder() {
        return getTcerFieldBuilder().getBuilder();
      }
      /**
       * <code>.Teacher tcer = 3;</code>
       */
      public TeacherOrBuilder getTcerOrBuilder() {
        if ((dataBodyCase_ == 3) && (tcerBuilder_ != null)) {
          return tcerBuilder_.getMessageOrBuilder();
        } else {
          if (dataBodyCase_ == 3) {
            return (Teacher) dataBody_;
          }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (tcerBuilder_ == null) {
          ...
          tcerBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              Teacher, Teacher.Builder, TeacherOrBuilder>(
                  (Teacher) dataBody_,
                  getParentForChildren(),
                  isClean());
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return MyInfo.internal_static_Student_descriptor;
    }

    @Override
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return MyInfo.internal_static_Student_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
    ...
    public static final class Builder extends
      ...
      // Construct using com.ls.netty.protobuf.MyInfo.Student.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return MyInfo.internal_static_Teacher_descriptor;
    }

    @Override
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return MyInfo.internal_static_Teacher_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
    ...
    public static final class Builder extends
      ...
      // Construct using com.ls.netty.protobuf.MyInfo.Teacher.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  static {
    String[] descriptorData = {
      "\n\nInfo.proto\"\237\001\n\tMyMessage\022%\n\010dataType\030\001" +
      " \001(\0162\023.MyMessage.DataType\022\027\n\003stu\030\002 \001(\0132\010" +
      ".StudentH\000\022\030\n\004tcer\030\003 \001(\0132\010.TeacherH\000\",\n\010" +
      "DataType\022\017\n\013StudentType\020\000\022\017\n\013TeacherType" +
      "\020\001B\n\n\010dataBody\"#\n\007Student\022\n\n\002id\030\001 \001(\005\022\014\n" +
      "\004name\030\002 \001(\t\"\"\n\007Teacher\022\n\n\002id\030\001 \001(\005\022\013\n\003ag" +
      "e\030\002 \001(\tB!\n\025com.ls.netty.protobufB\006MyInfo" +
      "H\001b\006proto3"
    };
    ...
    internal_static_MyMessage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_MyMessage_descriptor,
        new String[] { "DataType", "Stu", "Tcer", "DataBody", });
    internal_static_Student_descriptor =
